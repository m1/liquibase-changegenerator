...
[![Use this template](https://img.shields.io/badge/-Use%20this%20template-brightgreen)](https://github.com/m1/liquibase-changegenerator/generate) [![Pre Merge Checks](https://github.com/m1/liquibase-changegenerator/workflows/Pre%20Merge%20Checks/badge.svg)](https://github.com/m1/liquibase-changegenerator/actions?query=workflow%3A%22Pre+Merge+Checks%22)  [![License](https://img.shields.io/github/license/m1/kotlin-android-template.svg)](LICENSE) ![Language](https://img.shields.io/github/languages/top/m1/kotlin-android-template?color=blue&logo=kotlin)
...
Just click on [![Use this template](https://img.shields.io/badge/-Use%20this%20template-brightgreen)](https://github.com/m1/liquibase-changegenerator/generate) button to create a new repo starting from this template.
...
The [![Publish Plugin to Portal](https://github.com/m1/liquibase-changegenerator/workflows/Publish%20Plugin%20to%20Portal/badge.svg?branch=1.0.0)](https://github.com/m1/liquibase-changegenerator/actions?query=workflow%3A%22Publish+Plugin+to+Portal%22) Github Action will take care of the publishing whenever you **push a tag**.
...
This template is using [**GitHub Actions**](https://github.com/m1/kotlin-android-template/actions) as CI. You don't need to setup any external service and you should have a running CI once you start using this template.
